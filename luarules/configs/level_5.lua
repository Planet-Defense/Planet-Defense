...
--First weak wave
addWave(1,{"2 corlevlr", "2 armstump", "2 corlevlr", "2 tllcoyote", "1 aexxec", "2 corcrash"})
addWave(1,{"2 corlevlr", "2 armstump", "2 corlevlr", "2 armbull", "1 aexxec", "2 corcrash"})

--t1 only
newWaveSquad[2] =
addWave(2,{"5 armstump", "1 armbull", "1 armmerl", "5 armfast", "1 armbull", "1 armaak"})
addWave(2,{"2 tllcoyote", "1 corlevlr", "1 corhrk", "5 corpyro", "1 armspid", "1 armaak"})

--t1/t1.5
newWaveSquad[3] =
addWave(3,{"5 armflea", "5 armstump", "2 armmart", "2 armflash", "1 armspy1", "1 armaak"})
addWave(3,{"5 armstump", "1 cormort", "2 armbull", "2 armstump", "1 armspy1", "1 armaak"})

--t1.5 
newWaveSquad[4] = 
addWave(4,{"2 armlaspd", "2 armmart", "4 tllcoyote", "2 armflash1", "2 armraven1", "1 marauder"})
addWave(4,{"2 armlaspd", "2 armmerl", "2 armbull", "1 aexxec", "1 marauder", "2 armshock1"})
...
addWave(6,{"1 marauder", "1 corkarg", "1 armspy1", "1 requ2", "4 armsnipe", "1 heavyimpact", "1 corhrk1"})


newWaveSquad[7] =
addWave(7,{"1 tllcome", "1 armbanthaar", "2 requ3", "2 corcrw", "1 corhrk1", "2 roland", "10 corkarg"})
addWave(7,{"1 tllcome",  "5 airwolf3g", "1 requ2", "1 corhrk1", "1 roland", "1 armspy1", "1 armbanthaar", "10 corkarg"})


newWaveSquad[8] =
addWave(8,{"1 armbanth", "1 corkarg", "2 requ3", "1 corhrk1", "3 corkarg", "5 armsnipe", "2 airwolf3g", "2 roland"})
...
addWave(9,{"3 armraven", "1 corgala", "2 requ2", "2 roland", "1 corkrog", "1 corcomh"})
