...
--First weak wave
addWave(1,{"1 roland", "1 corack", "1 armack", "1 tllack", "4 corak", "1 armfark", "10 corpyro"})
addWave(1,{"1 roland", "1 armack", "1 armfark", "1 corack", "10 armfast", "1 tllack"})

--t1 only
newWaveSquad[2] =
addWave(2,{"5 armflea", "1 tllcoyote", "4 corthud", "5 armthund", "3 aexxec", "3 corcrash"})
addWave(2,{"5 armflea", "1 tllcoyote", "4 corthud", "5 armthund", "3 aexxec", "3 corcrash"})

--t1/t1.5
newWaveSquad[3] =
addWave(3,{"5 armsam", "5 aexxec", "2 corthud1", "7 armthund", "1 armfark", "1 armaak"})
addWave(3,{"5 armsam", "1 armfark", "4 corthud1", "5 aexxec", "12 armthund", "1 armaak"})

--t1.5 
newWaveSquad[4] = 
addWave(4,{"20 bladew", "5 armstump", "4 tllcoyote", "4 armsam1", "4 armsam1", "4 corthud1"})
addWave(4,{"20 bladew", "5 armstump", "4 armsam1", "5 armstump", "5 armstump", "4 armraven1"})


--t1.5/t2
newWaveSquad[5] =
addWave(5,{"3 marauder", "2 tankanotor", "3 armzeus", "1 corhrk1", "1 tllblind", "3 tllcoyote", "5 corsumo", "1 armaak"})
addWave(5,{"2 tankanotor", "1 armbanth", "3 armzeus", "5 corgol", "5 armbull", "1 tllblind", "1 corhrk1"})


--t2 --wip beyond
newWaveSquad[6] =
addWave(6,{"4 corprot", "5 marauder", "1 cormonsta", "1 tllcome", "1 armbanth", "5 cormddm", "1 roland"})
addWave(6,{"4 corprot", "5 corkarg", "1 cormonsta", "3 armraz", "1 tllcome", "2 armraven", "1 corhrk1"})


newWaveSquad[7] =
addWave(7,{"2 armcomm", "1 corkrog", "2 requ3", "2 corcrw", "1 corhrk1", "1 roland", "1 anvil"})
addWave(7,{"2 armcomm",  "5 airwolf3g", "1 requ2", "1 corhrk1", "5 roland", "1 corkrog", "1 anvil", "4 armorion"})


newWaveSquad[8] =
addWave(8,{"1 corcomh", "1 anvil", "1 mammouth", "1 corhrk1", "5 corkarg", "5 corprot", "2 airwolf3g", "2 roland"})
addWave(8,{"1 corcomh", "1 anvil", "3 requ3", "1 corhrk1", "5 armbanth", "5 armshock", "1 corkrog", "3 corcrw"})


newWaveSquad[9] =
addWave(9,{"2 requ3", "1 corgala", "2 corcrw", "5 corkarg", "2 mammouth", "2 roland"})
addWave(9,{"5 armraven", "1 corgala", "2 requ2", "7 roland", "1 hyperion", "1 corcomh"})


newWaveSquad[10] =
addWave(10,{"1 anvil", "1 armcomm", "2 corcrw", "2 corkarg", "4 mammouth", "2 roland", "3 wplatform", "1 arm_furie", "3 armorion"})
addWave(10,{"1 anvil", "1 armcomm", "2 airwolf3g", "3 roland", "1 hyperion", "1 corcomh", "1 armcomm", "3 wplatform", "6 heavyimpact"})


newWaveSquad[11] =
addWave(11,{"2 arm_furie", "1 corkrog1", "1 corhrk1", "2 requ2", "5 corcrw", "5 corgala", "1 corcomh", "1 abroadside"})
...
if (queenName == "n_chickenqr") then addWave(12,{"2 tllvaliant" ,"2 corkrog1", "2 corcomh", "20 roland", "5 requ3"}) end
